...
minikube service cyber-mavericks  # Open service
```

### Apply Changes

```zsh
minikube image build -t cyber-mavericks:$(date +%Y%m%d%H%M%S) -f ./Dockerfile .
minikube image ls --format table
# Update image tag in deployment.yaml
kubectl apply -f deployment.yaml
minikube service cyber-mavericks
```

## Clean Up

```zsh
kubectl delete service cyber-mavericks  # Delete service
kubectl delete deployment cyber-mavericks  # Delete deployment
minikube image rm cyber-mavericks  # Remove image
